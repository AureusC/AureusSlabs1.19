...
public enum ModArmorMaterials implements ArmorMaterial {
    GLOW_BERRY_GOGGLES("glow_berry_goggles", 25, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_LEATHER,
            0.0F, 0.0F, () -> {return Ingredient.of(Items.GLOW_BERRIES);});
    ...
    public String getName() {
        return AureusStuff.MOD_ID + ":" + this.name;
    }
